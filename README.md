...
.withFallbacks()
Om min runnable misslyckats så fångar denna upp det och kan i sin tur starta upp en annan fallback såsom t.ex. annan runnable eller i mitt fall en enkel console.log. Den går att applicera på runnables, inte specifikt bara min chain, utan där det passar.

Det går även att använda RunnableWithFallbacks. Där sätter man keyvaluepar för sin fallback utöver den runnable man vill ska utföras i första hand.
const manualFallbackChain = new RunnableWithFallbacks({
runnable: "min runnable"
